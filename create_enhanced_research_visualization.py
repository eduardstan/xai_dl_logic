...
def create_metrics_overview(df_all, df_selected, output_dir):
    ...
    # Balanced transparency for clear overlap visualization
    ...
    plt.tight_layout()
    plt.savefig(output_dir / 'metrics_overview.png', dpi=300, bbox_inches='tight', facecolor='white')
    print("📊 Metrics overview visualization saved!")
